...
IplImage *ImageDLL::corners(IplImage *srcImage, IplImage *dstImage)             //角点提取
{
...
IplImage *ImageDLL::Houghline(IplImage* src, IplImage* color_dst)            //Hough直线提取
{
	IplImage* dst;
...
IplImage *ImageDLL::Houghcircle(IplImage* img, IplImage* dst)      //Hough圆提取
{
...
CvSeq* ImageDLL::Hougrectangular(IplImage* img, CvMemStorage* storage)      //Hough矩形提取
{
	CvSeq* contours;
	int i, c, l, N = 11;
...
IplImage *ImageDLL::Textureextraction(IplImage* img, IplImage* dst)     //纹理提取
{
	int tmp[8] = { 0 };
	int sum = 0; int k = 0;
	CvScalar s;
